...
class AppConstants {
  ...
  static const String Trems_Conditions = '/api/v1/staticpages/terms-condition';
  static const String Faq = '/api/v1/staticpages/faq';
  static const String About_Us = '/api/v1/staticpages/about-us';
  static const String Nutrition = '/api/v1/staticpages/nutrition';
  // Shared Key
