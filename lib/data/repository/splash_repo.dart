...
class SplashRepo {
  ...
  Future<ApiResponse> getStaticPageData({int type}) async {
    try {
      String url = "";
      if (type == 0) {
        url = AppConstants.Trems_Conditions;
      } else if (type == 1) {
        url = AppConstants.Nutrition;
      } else if (type == 2) {
        url = AppConstants.Faq;
      } else {
        url = AppConstants.About_Us;
      }
