...
class Product {
  ...
  Product(
    ...
    this._addOns = addOns;
    this._addOns2 = addOns2;
    this._addOns1 = addOns1;
    this._tax = tax;
  ...
  List<AddOns> get addOns2 => _addOns2;
  List<AddOns> get addOns1 => _addOns1;
  double get tax => _tax;
  ...
  Product.fromJson(Map<String, dynamic> json) {
    print("json obj add_ons2 ${json['add_ons2']}");
    print("json obj add_ons ${json['add_ons']}");
    print("json obj set_menu ${json['set_menu']}");
    ...
    if (json['add_ons'] != null) {
      ...
      json['add_ons'].forEach((v) {
        if (v['addon_type'] == 'Upsize') {
          _addOns2.add(new AddOns.fromJson(v));
        } else if (v['addon_type'] == 'Add On') {
    ...
    if (json['add_ons2'] != null) {
      _addOns2 = [];
      json['add_ons2'].forEach((v) {
        _addOns2.add(new AddOns.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this._addOns2 != null) {
      data['add_ons2'] = this._addOns2.map((v) => v.toJson()).toList();
    }
    if (this._addOns1 != null) {
      data['add_ons1'] = this._addOns1.map((v) => v.toJson()).toList();
    }
    data['tax'] = this._tax;
...
class AddOns {
  ...
  String get name => _name;
  double get price => _price;
  List<AddOns1> get addOns1 => addOns1;
  String get createdAt => _createdAt;
  String get updatedAt => _updatedAt;
...
class AddOns1 {
  ...
  String get updatedAt => _updatedAt;
  String get addontype => _addontype;
  AddOns1.fromJson(Map<String, dynamic> json) {
    _id = json['id'];
    _name = json['name'];
    _price = double.parse(json['price'].toString());
    _createdAt = json['created_at'];
